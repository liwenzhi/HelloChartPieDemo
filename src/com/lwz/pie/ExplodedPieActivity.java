 ...
 * 设置isExploded为true即可！
 */
public class ExplodedPieActivity extends Activity {

    private PieChartView pieChart;     //饼状图View
    private PieChartData data;         //存放数据

    private boolean hasLabels = false;                   //是否有标语
    ...
    private class ValueTouchListener implements PieChartOnValueSelectListener {
        ...
        public void onValueSelected(int arcIndex, SliceValue value) {
            Toast.makeText(ExplodedPieActivity.this, "Selected: " + value, Toast.LENGTH_SHORT).show();
        }
